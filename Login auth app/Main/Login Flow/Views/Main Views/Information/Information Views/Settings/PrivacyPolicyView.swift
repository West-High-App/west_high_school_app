        ...
        ScrollView{
                VStack{
                    ...
                    VStack(alignment: .leading){
                        ...
                        Text("For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to email and name. The information that we request will be retained by us and used as described in this privacy policy.")
                    ...
                    VStack(alignment: .leading){
                        ...
                        Text("This policy is effective as of 2023-08-30\n")
                        Text("**Contact Us**")
                        Text("If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at westhighapp@gmail.com.\n")
                    }
