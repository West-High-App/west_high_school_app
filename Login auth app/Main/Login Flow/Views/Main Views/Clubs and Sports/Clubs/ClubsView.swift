...
struct ClubsHibabi: View {
    ...
    @StateObject var clubNewsManager = clubsNewslist.shared // clubNewsManager = clubsNewslist.shared // MARK: think it has to do with this bitch (don't use singleton, or make it consistent, just follow sports framework)
