...
struct ClubsHibabi: View {
    ...
    @State var clubNewsManager = clubsNewslist() // clubNewsManager = clubsNewslist.shared // MARK: think it has to do with this bitch (don't use singleton, or make it consistent, just follow sports framework)
