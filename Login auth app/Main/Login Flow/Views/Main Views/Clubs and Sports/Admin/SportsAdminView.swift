            ...
            .sheet(isPresented: $isPresentingAddSport) {
                ...
                Form {
                    ...
                    Button("Publish New Sport") {
                            ...
                            sportToAdd = sport(sportname: sportname, sportcoaches: sportcoaches, adminemails: adminemails, sportsimage: sportsimage, sportsteam: sportsteam, sportsroster: sportsroster, sportscaptains: sportscaptains, tags: tags, info: info, favoritedusers: [], imagedata: nil, documentID: "NAN", sportid: "\(sportname) \(sportsteam)", id: 0)
